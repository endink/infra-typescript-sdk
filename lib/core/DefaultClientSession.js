...
var DefaultClientSession = {
    user: new oauht2_1.UserPrincipal(),
    get isLogged() {
    ...
    clearToken: function () {
        ...
        this.user = new oauht2_1.UserPrincipal();
    ...
    loadToken: function () {
        ...
        if ((typeof json) === "string" && json != null) {
            ...
            if (saved.version !== version) {
                ...
                this.user = new oauht2_1.UserPrincipal(this.accessToken.user_id, this.accessToken.user_name, this.accessToken.roles, this.accessToken.two_factor_granted);
                this.acccessTokenCreated = saved.created;
            }
        }
    },
    saveToken: function (token) {
        this.user = new oauht2_1.UserPrincipal(token.user_id, token.user_name, token.roles, token.two_factor_granted);
