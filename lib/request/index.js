...
var DefaultClientSession_1 = require("../core/DefaultClientSession");
...
function initRequest(options, clientSession) {
    var _this = this;
    var clientId = options.clientId, clientSecret = options.clientSecret;
    var currentSession = clientSession || DefaultClientSession_1.DefaultClientSession;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(ctx.req.options["skipAuth"] !== true && currentSession.isLogged)) return [3 /*break*/, 4];
                    if (!currentSession.isTokenExpired) return [3 /*break*/, 2];
                    data = {
