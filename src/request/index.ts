...
export function initRequest(options: RequestOptions, session?: OAuth2Session) {
    ...
    request.use(async (ctx, next) => {
        if (ctx && ctx.req && ctx.req.options && typeof ctx.req.options.errorHandler === "undefined") {
            ...
            op.errorHandler = e => {
                return handleError(e, options, op.skipNotifyError)
            }
        }
    ...
    r.login = (param: LoginParam, options?: OAuth2RequestOptions) => {
    ...
    r.checkToken = async (options?: OAuth2RequestOptions & { tokenValue?: string }) => {
